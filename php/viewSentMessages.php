...
$SQL = "SELECT " . MESSAGE_TABLE . ".id, " . MESSAGE_TABLE . ".message, " . MESSAGE_TABLE . ".receiver, " . MESSAGE_TABLE . ".sent_time, " . STUDENT_TABLE . ".fname, " . STUDENT_TABLE . ".mname, " . STUDENT_TABLE . ".lname FROM " . MESSAGE_TABLE . " INNER JOIN " . STUDENT_TABLE . " ON " . STUDENT_TABLE . ".rollno=" . MESSAGE_TABLE . ".receiver WHERE sender = ?";
...
while ($row = mysqli_fetch_array($result)){
    ...
    $posts[] = array('sender'=>$receiver, 'name'=>$name, 'msg'=>$msg, 'time'=>$time, 'id'=>$id);
}
