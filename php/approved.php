...
if (!$stmt->bind_param("sii", $requested, $rollno, $approved)) {
...
<head>
    ...
    <title>UseIt - Approved Requests</title>
...
<script>
    ...
    if(subjectJSON!==null)
    {
        ...
        for(var i = 0; i < subject.length; i++) {
            ...
            request.innerText = "Confirm Delivery";
            ...
            request.setAttribute("data-target", "./delivered.php?id=" + subject[i].id);
