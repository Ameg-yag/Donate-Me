...
$SQL = "SELECT * FROM " . UPLOAD_TABLE . " WHERE requested = ? AND uploader = ? AND approved = ?";
...
while ($row = mysqli_fetch_array($result)){
    ...
    $posts[] = array('id'=> $id, 'uploader'=>$uploader, 'type'=>$type, 'location1'=>$location1, 'location2'=>$location2, 'requestedBy'=>$requestedBy, 'code'=>$code);
}
...
<head>
    ...
    <title>UseIt - Received Requests</title>
...
<div class="container">
    <div class="center">
        ...
        <a href="viewBook.php" class="btn">The Book List</a><br><br>
...
<script>
    ...
    if(subjectJSON!==null)
    {
        ...
        for(var i = 0; i < subject.length; i++) {
            ...
            var strongFor  = document.createElement("strong");
            var spanUploader  = document.createElement("span");
            var spanFor  = document.createElement("span");
            ...
            strongBy.innerText = "From";
            // strongFor.innerText = "For";
            // spanFor.innerText = subject[i].code;
            ...
            spanUploader.innerText = subject[i].requestedBy;
            request.innerText = "Delete Request";
            approve.innerText = "Accept";
            ...
            p2.setAttribute("class", "card blue");
            ...
            approve.setAttribute("data-target", "./approveRequest.php?id=" + subject[i].id);
            approve.setAttribute("href", "#!");
            approve.setAttribute("class", "accept yellow-text");

            p4.appendChild(approve);
            ...
            // p3.appendChild(br2);
            // p3.appendChild(br4);
            // p3.appendChild(strongFor);
            // p3.appendChild(br5);
            // p3.appendChild(spanFor);
            // p3.appendChild(br9);
